...
export const Popover: ComponentConfig<PopoverProps> = {
  ...
  defaultProps: {
    ...
    styles: {
      content: "z-50 w-48 rounded-lg p-4 shadow-md md:w-56 bg-white dark:bg-gray-800",
      ...
      input: "block w-1/2 rounded-md text-xs border border-gray-400 focus-visible:ring focus-visible:ring-purple-500",
      close: "absolute top-3.5 right-3.5 inline-flex items-center justify-center rounded-full p-1"
    }
  },
