...
export const Menubar: ComponentConfig<MenubarProps> = {
  ...
  defaultProps: {
    ...
    styles: {
      ...
      trigger:clsx ("cursor-default radix-disabled:opacity-50 radix-disabled:cursor-not-allowed",
      ...
      submenuTrigger: clsx(      "cursor-default radix-disabled:opacity-50 radix-disabled:cursor-not-allowed",
        "px-3 py-1 text-sm rounded-md hover:bg-gray-100 dark:hover:bg-gray-900",
        "text-sm font-medium",
        "text-gray-700 dark:text-gray-100",
        "focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75",
        "flex w-full items-center justify-between px-2 py-1.5 text-sm rounded-md text-gray-700 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none"),
